...
function Players({ playerScores, playerUid, togglePlayerActive }) {
  ...
  return (
    <div class="players flex-grow--1 container flex direction--column align-items--center margin--base padding--large overflow--hidden md:height--50-pct lg:height--50-pct">
